									...
									<div class="row">
										<div class="col-12 col-md-6">
											<div class="form-group">
												<label for="numero_solicitud_reg" class="bmd-label" style="margin-top:-4%;">Numero de solicitud</label>
										...
										<div class="col-12 col-md-5">
											<div class="form-group">
												<label for="fecha_emision" class="bmd-label" style="margin-top:-6%;">Fecha de Emision del proveído</label>
										...
										<div class="col-12 col-md-6">
											<div class="form-group">
												<label for="fecha_recepcion" class="bmd-label" style="margin-top:-6%;">Fecha de recepción del proveído</label>
												<input type="date" class="form-control" name="fecha_recepcion" id="fecha_recepcion" required>
											</div>
										</div>
										<div class="col-12 col-md-6">
											<div class="form-group">
												<label for="item_dependencia_reg" class="bmd-label" style="margin-top:-4%;">Fiscalía que Remite</label>
										...
										<div class="col-12 col-md-6">
											<div class="form-group">
												<label for="especificar" class="bmd-label" style="margin-top:-4%;">Especifique Cual</label>
										...
										<div class="container-fluid">
											<div class="row">
												<div class="col-12 col-md-4">
													<div class="form-group">
														<label for="nombre" class="bmd-label" style="margin-top:-4%;">Nombre</label>
												...
												<div class="col-12 col-md-4">
													<div class="form-group">
														<label for="apellido" class="bmd-label" style="margin-top:-4%;">Apellido</label>
												...
												<div class="col-12 col-md-4">
													<div class="form-group">
														<label for="dni" class="bmd-label" style="margin-top:-4%;">DNI</label>
														<input type="text" class="form-control" name="dni" id="dni" required maxlength="13">
													...
													<fieldset>
														...
														<div class="container-fluid">
															<div class="row">
																...
																<div class="col-12 col-md-6">
																	<div class="form-group">
																		<label for="item_departamento_reg" class="bmd-label" style="margin-top:-4%;">Departamento del hecho</label>
																...
																<div class="col-12 col-md-5">
																	<div class="form-group">
																		<label for="item_municipio_reg" class="bmd-label" style="margin-top:-4%;">Municipio del hecho</label>
																...
																<div class="col-12 col-md-6">
																	<div class="form-group">
																		<label for="aldea_barrio" class="bmd-label" style="margin-top:-4%;">Caserío, Aldea o Barrio, del Hecho</label>
																...
																<div class="col-12 col-md-6">
																	<div class="form-group">
																		<label for="lugar" class="bmd-label" style="margin-top:-4%;">Lugar Donde Ocurrió el Hecho</label>
																...
																<div class="col-12 col-md-6">
																	<div class="form-group">
																		<label for="fecha_hecho" class="bmd-label" style="margin-top:-4%;">Fecha que Ocurrió el Hecho</label>
										...
										<div class="col-12 col-md-6">
											<div class="form-group">
												<label for="item_recon_reg" class="bmd-label" style="margin-top:-4%;">Reconocimiento</label>
										...
										<div class="col-12 col-md-6">
											<div class="form-group">
												<label for="medico" class="bmd-label" style="margin-top:-4%;">Medico</label>
