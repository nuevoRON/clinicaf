...
<body>
	<main class="full-box main-container">
		...
		<section class="full-box page-content">
			...
			<div class="full-box">
				<h4 class="text-left">
					<i class="fas fa-user-tie"></i>&nbsp; PUESTOS
				</h4>
			</div>
										...
										<div class="row">
											<div class="col-12 col-md-8">
												<div class="form-group">
													<label for="puesto" class="bmd-label" style="margin-top:-3%;">Nombre de Puesto</label>
											...
											<div class="col-12 col-md-8">
												<div class="form-group">
													<label for="estado" class="bmd-label" style="margin-top:-3%;">Estado</label>
